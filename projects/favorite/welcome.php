...
<head><meta name="generator" content="Hexo 3.9.0">
    <meta charset="utf-8">
    <meta name="keywords" content="友情链接, ECNU DaSE">
    <meta name="baidu-site-verification" content>
    <meta name="google-site-verification" content>
    <meta name="360-site-verification" content>
    <meta name="description" content="友情链接 | Antares-Wu&#39;s blog">
    ...
    <title>在线收藏夹 | Antares-Wu&#39;s blog</title>
...
<div class="bg-cover pd-header about-cover">
    <div class="container">
        ...
        <script>
            ...
            $('.bg-cover').css('background-image', 'url(https://gitee.com/wu_lin_long/image/raw/master/img/' + new Date().getDay() + '.jpg)');
        </script>
    </div>
</div>
<style>
            ...
            <div class="card-content">
                <div class="card-content article-card-content">
                    <div id="articleContent" data-aos="fade-up">
                        <h1 id="在线收藏夹"><a href="#在线收藏夹" class="headerlink" title="在线收藏夹"></a>在线收藏夹</h1>
...
<footer class="page-footer bg-color">
    <div class="container row center-align">
        <div class="col s12 m8 l8 copy-right">
            &copy; 2020 powered by wulinlong. All Rights Reserved.


            <span id="icp"><img src="/medias/icp.png"  style="vertical-align: text-bottom;" />
                <a href="http://www.beian.miit.gov.cn" target="_blank">沪ICP备20006975号</a>
            </span>
            ...
            <span class="white-color">6.4k</span>
        ...
        <div class="col s12 m4 l4 social-link social-statis">
            <a href="https://github.com/Antares-Wu" class="tooltipped" target="_blank" data-tooltip="访问我的GitHub" data-position="top" data-delay="50">
                <i class="fa fa-github"></i>
            </a>



            <a href="mailto:wulinlong1231@163.com" class="tooltipped" target="_blank" data-tooltip="邮件联系我" data-position="top" data-delay="50">
                <i class="fa fa-envelope-open"></i>
            </a>



            <a href="https://zhihu.com/people/wu-lin-long-93" class="tooltipped" target="_blank" data-tooltip="访问我的知乎" data-position="top" data-delay="50">
                <i class="fa fa-inverse">知</i>
            </a>



            <a href="https://user.qzone.qq.com/1911993260" class="tooltipped" target="_blank" data-tooltip="访问我的QQ空间" data-position="top" data-delay="50">
                <i class="fa fa-qq"></i>
            </a>



            <a href="https://weibo.com/u/3623523107/home?topnav=1&amp;wvr=6" class="tooltipped" target="_blank" data-tooltip="关注我的微博" data-position="top" data-delay="50">
...
<script language=javascript>
    function siteTime() {
        ...
        var t1 = Date.UTC(2020, 02, 28, 03, 12, 00); //北京时间2018-2-13 00:00:00
...
<script type="text/javascript"> var OriginTitile = document.title, st; document.addEventListener("visibilitychange", function () { document.hidden ? (document.title = "(づ￣ 3￣)づBye~", clearTimeout(st)) : (document.title = "φ(゜▽゜*)♪Welcome！", st = setTimeout(function () { document.title = OriginTitile }, 3e3)) })
</script>
